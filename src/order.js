...
const OrderData = ({cart, show, OnTable, orderstatus}) => {
...
<section className="main">
  ...
  <h1 className="text-center mt-3" style={{fontFamily: 'Aclonica', textShadow: '1.2px 2px 3px #6c6767',
    color: '#d82643'}}>MY ORDER</h1>

    <hr/>
    <div className="row">
    {cookies.user && cookies.user[0].data.map(({id,img,qty,title,mrp,price}) => (
      ...
      <div className={`col-12 ${show} mt-3`}>
        <div className="card mb-4">
          ...
          <div className="card-body">
            ...
            <button onClick={OnTable} className="btn btn-primary btn-lg btn-block">
              Order On Table
            </button>
          </div>
        </div>
